...
func ListCluster() {
	...
	for _, info := range dir {
		...
		fmt.Printf("%-15s  %-10s  %-10s  %-25s  %-60s  %-50s\n", clusterName,
			...
			module.GConfigInfo.ClusterInfo.User,
			module.GConfigInfo.ClusterInfo.CreateDate,
			module.GConfigInfo.ClusterInfo.MetaPath,
			module.GConfigInfo.ClusterInfo.PrivateKey)
	}
